...
import { FilesAuxComponentType } from '../types/components.types';

import styles from './filesListAux.module.scss';
...
export default function FileListComponent({
  ...
  let fileList: filesType = [];
  if (dataFileList) {
    fileList = dataFileList[nameByPk][fieldName] || [];
    fileList = fileList.filter((file) => file.link);
  }
